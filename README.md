...
| :------------------------------------- | ---------------------------------------- | ----------------------------- | ---------------------------------------- |
| Java, JavaScript, TypeScript, Ruby on Rails, PHP, Android | HTML, CSS, Bootstrap v4, D3.js, Angular v11+, React | MongoDB, Node.js, Express.js, Spring Boot 2+, Oracle, MySQL, PostgreSQL | Git, Apache, UNIX, Agile, Scrum, SEO |
